  ...
  return (
    ...
    <div className="min-h-screen bg-[#FCFBF8] flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
        <div className="absolute top-10 left-10 w-32 h-32 bg-purple-200 rounded-full mix-blend-multiply filter blur-2xl"></div>
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-pink-200 rounded-full mix-blend-multiply filter blur-2xl"></div>
      </div>

      {/* Back Button */}
      <div className="absolute top-4 left-4 sm:top-8 sm:left-8 z-50">
        <Link href="/" className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 rounded-2xl font-comic font-bold text-gray-600 hover:text-[#8B5CF6] hover:border-[#8B5CF6] shadow-sm transition-all hover:-translate-x-1">
      ...
      <div className="max-w-[1200px] w-full min-h-[800px] bg-[#FFFDFC] shadow-2xl relative flex rounded-r-3xl overflow-hidden border border-gray-100">
        ...
        <div className="flex-1 p-10 md:p-16 flex flex-col lg:flex-row gap-16 relative z-10">
          ...
          <div className="flex-1 max-w-lg">
            ...
            {/* Header */}
            <div className="mb-16">
              <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 bg-[#F3E8FF] border border-purple-200 rounded-full text-[#8B5CF6] transform -rotate-1">
                <Star className="w-4 h-4 fill-current" />
                <span className="font-balsamiq font-black text-sm uppercase tracking-wider">FormForge</span>
              </div>
              <h1 className="font-balsamiq text-5xl font-black text-gray-900 mb-3">Welcome back! 👋</h1>
              <p className="font-comic text-gray-500 font-bold text-lg inline-block relative">
                ...
                <svg className="absolute -bottom-2 left-0 w-full h-2" viewBox="0 0 100 10" preserveAspectRatio="none">
                  <path d="M0 5 Q 12.5 0, 25 5 T 50 5 T 75 5 T 100 5" fill="none" stroke="#D8B4FE" strokeWidth="2" />
                </svg>
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="you@example.com"
                        className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl font-comic font-bold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-300 focus:bg-white focus:ring-4 focus:ring-purple-50 transition-all shadow-sm" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="••••••••"
                        className="w-full pl-12 pr-12 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl font-comic font-bold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-300 focus:bg-white focus:ring-4 focus:ring-purple-50 transition-all shadow-sm" />
                  ...
                  <div className="pt-2">
                    <button type="submit" disabled={loading}
                      className="w-full py-4 bg-purple-500 text-white border border-purple-600 rounded-2xl font-balsamiq font-bold text-lg shadow-sm hover:-translate-y-0.5 hover:bg-purple-600 hover:shadow-md active:translate-y-0 transition-all flex justify-center items-center gap-2">
          ...
          <div className="hidden lg:flex flex-1 flex-col relative items-center justify-center">
            ...
            {/* Speech Bubble */}
            <div className="absolute top-10 right-20 bg-white border border-gray-200 rounded-[2rem] p-6 shadow-sm z-10 font-comic font-bold text-lg text-gray-700 max-w-[280px]">
              <p>Set your password like a hacker would set it.</p>
              <p className="mt-4 flex items-center gap-2">Be smart. <br /> Be secure. <Lock className="w-5 h-5 text-purple-500 inline" /></p>
              {/* Speech bubble pointer */}
              <div className="absolute -bottom-3 left-10 w-6 h-6 bg-white border-b border-l border-gray-200 transform -rotate-45"></div>
            </div>
            ...
            <div className="w-64 h-[400px] mt-20 relative flex items-center justify-center group cursor-pointer">
              ...
              <motion.div animate={{ rotate: [0, 10, 0], scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="absolute top-20 -left-10 text-4xl">✨</motion.div>
              <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 3, delay: 1 }} className="absolute bottom-20 -right-5 text-3xl">🚀</motion.div>
            </div>

            {/* Sticky Note */}
            <div className="absolute bottom-32 right-10 w-64 bg-[#F0FDF4] sticky-note transform rotate-2 shadow-sm rounded-lg p-5 border border-green-100">
              <div className="washi-tape -top-3 left-1/2 -translate-x-1/2 bg-green-200" style={{ transform: "rotate(-1deg)" }}></div>
              <h3 className="font-balsamiq font-bold text-gray-900 flex items-center gap-2 mb-3">
                Security Tip <ShieldCheck className="w-4 h-4 text-green-500" />
              </h3>
              <ul className="font-comic text-sm font-bold text-gray-600 space-y-2">
                <li className="flex items-start gap-2"><span className="text-green-500">✓</span> Use 8+ characters</li>
                <li className="flex items-start gap-2"><span className="text-green-500">✓</span> Mix letters, numbers & symbols</li>
                <li className="flex items-start gap-2"><span className="text-green-500">✓</span> Avoid common words</li>
              </ul>
            </div>
